/* AMKN8639 V16b - PLL Clock Config + QSPI test */
...
static void SystemClock_Config(void) {
    ...
    /* Voltage scaling VOS1 for 240MHz */
    PWR_D3CR |= (1<<14);
    while(!(PWR_CSR1 & (1<<14))) {}
    ...
    /* PLL: HSI 64MHz, DIVM=4(reg=3), DIVN=30(reg=29), DIVP=2(reg=1) */
    /* Input=16MHz, VCO=480MHz, SYSCLK=240MHz */
    RCC_PLLCKSELR = (3 << 4);
    
    RCC_PLLCFGR = (1 << 1) | (3 << 2) | (29 << 4);
