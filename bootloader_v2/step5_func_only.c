...
/* Defined but NOT called - test if function presence breaks things */
...
/* Dummy ref to prevent dead-code elimination */
const void* keep_uart = (void*)uart_puts;
