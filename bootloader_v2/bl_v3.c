...
/* ARMCC asm function - set MSP and jump */
...
void Reset_Handler(void){
    ...
    uart_puts("OTA: "); uart_puthex(ota_magic, 8);
    uart_puts(" "); uart_puthex(ota_status, 8);
    uart_puts("\n");
    ...
    if(app_sp > 0x20000000 && app_sp < 0x38010000 &&
       app_pc > 0x08000000 && app_pc < 0x08200000){
        uart_puts("BOOT APP\n");
        led_blink(1, 200);
        delay_loops(6400000);
